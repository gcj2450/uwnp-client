...
namespace Sfs2X.Bitswarm
{
	public class WebSocketClient : ISocketClient, IDispatchable
	{
		...
		private void AddController(int id, IController controller)
		{
			...
			{
				throw new ArgumentException("A controller with id: " + id + " already exists! Controller can't be added: " + ((controller != null) ? controller.ToString() : null));
			}
