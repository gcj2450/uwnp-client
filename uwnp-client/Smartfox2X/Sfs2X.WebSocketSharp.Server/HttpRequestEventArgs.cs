...
namespace Sfs2X.WebSocketSharp.Server
{
	...
	/// the <see cref="T:Sfs2X.WebSocketSharp.Server.HttpServer" />.
	/// </summary>
	/// <remarks>
	///   <para>
	...
	///   </para>
	///   <para>
	///   And you should access the <see cref="P:Sfs2X.WebSocketSharp.Server.HttpRequestEventArgs.Response" /> property if you would
