...
namespace Sfs2X.WebSocketSharp.Server
{
	...
	public abstract class WebSocketBehavior : IWebSocketSession
	{
		...
		///   </para>
		///   <para>
		///   <see cref="F:Sfs2X.WebSocketSharp.WebSocketState.Connecting" /> if the session has not
		///   started yet.
		///   </para>
		/// </value>
		...
		/// <summary>
		/// Calls the <see cref="M:Sfs2X.WebSocketSharp.Server.WebSocketBehavior.OnError(Sfs2X.WebSocketSharp.ErrorEventArgs)" /> method with the specified message.
		/// </summary>
		/// <param name="message">
