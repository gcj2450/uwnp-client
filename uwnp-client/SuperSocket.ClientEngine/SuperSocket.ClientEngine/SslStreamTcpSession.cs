...
namespace SuperSocket.ClientEngine
{
	public class SslStreamTcpSession : AuthenticatedStreamTcpSession
	{
		protected override void StartAuthenticatedStream(Socket client)
		{
			...
			SslStream sslStream = new SslStream(new NetworkStream(client), false, ValidateRemoteCertificate);
			sslStream.BeginAuthenticateAsClient(base.HostName, security.Certificates, security.EnabledSslProtocols, false, OnAuthenticated, sslStream);
		}
