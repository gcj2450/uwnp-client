						...
						if (!flag2 && text3.Length > 0)
						{
							if (text3[0] == SLASH)
							{
								if (text4.Length > 0)
								{
									...
									xMLNode4["_text"] = ((obj != null) ? obj.ToString() : null) + text4;
								}
								text4 = "";
								text3 = "";
