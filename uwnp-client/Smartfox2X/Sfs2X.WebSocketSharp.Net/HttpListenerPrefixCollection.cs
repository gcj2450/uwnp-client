...
{
	/// <summary>
	/// Provides the collection used to store the URI prefixes for the <see cref="T:Sfs2X.WebSocketSharp.Net.HttpListener" />.
	/// </summary>
	/// <remarks>
	/// The <see cref="T:Sfs2X.WebSocketSharp.Net.HttpListener" /> responds to the request which has a requested URI that
	...
	public class HttpListenerPrefixCollection : ICollection<string>, IEnumerable<string>, IEnumerable
	{
		...
		/// The <see cref="T:Sfs2X.WebSocketSharp.Net.HttpListener" /> associated with this collection is closed.
		/// </exception>
		...
		/// <summary>
		/// Gets the enumerator used to iterate through the <see cref="T:Sfs2X.WebSocketSharp.Net.HttpListenerPrefixCollection" />.
		/// </summary>
		/// <returns>
