...
namespace Sfs2X.WebSocketSharp
{
	internal class WebSocketFrame : IEnumerable<byte>, IEnumerable
	{
		...
		internal int ExtendedPayloadLengthCount
		{
			get
			{
				return (_payloadLength >= 126) ? ((_payloadLength == 126) ? 2 : 8) : 0;
			}
		}
		...
		internal ulong FullPayloadLength
		{
			get
			{
				return (_payloadLength < 126) ? _payloadLength : ((_payloadLength == 126) ? _extPayloadLength.ToUInt16(ByteOrder.Big) : _extPayloadLength.ToUInt64(ByteOrder.Big));
			}
		}
