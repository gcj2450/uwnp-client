...
namespace ServerSDK.Network
{
    public class WebSocket : IWebSocket
    {
        ...
        public void SendAsync(byte[] data)
        {
            if (!isOpening)
            {
                Debug.LogError("WebSocket.SendAsync - is opening false");
                HandleError(new Exception("WebSocket.SendAsync - is opening false"));
                return;
            }
...
#else
            OnError?.Invoke(this, new ErrorEventArgs(exception.Message, exception));
#endif
        }
